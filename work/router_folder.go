...
// reads to install the site. Same argument shapes as robots/sitemap.
//
...
// Highlight pins the site-wide palette for highlighted code blocks — e.g.
// router.highlight("tokyonight"). A map form carries the theme plus per-role
// overrides, so one call owns the whole appearance of a code block and the
// theme name is never written twice.
//
//	router.highlight("tokyonight")
//	router.highlight({ theme: "tokyonight", keyword: "#ff0000" })
