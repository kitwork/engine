...
var DefaultConfig = Config{
	Colors: map[string]Color{
		...
		"kitwork":      Hex("#f82244"),
		"brand":        Hex("#f82244"),
		"brand-light":  Hex("#ff758f"),
		"brand-accent": Hex("#f7768e"),
	},
	...
	MediaQueries: map[string]string{
		// Custom industrial system (max-width).
		...
		"max-lg":  "@media (max-width: 1023.98px)",
		"max-xl":  "@media (max-width: 1279.98px)",
		"max-2xl": "@media (max-width: 1535.98px)",
	},
