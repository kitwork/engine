...
__runStandaloneKitTest(async function () {
  ...
  await waitFor(function () { return document.getElementById("count").textContent === "0"; }, "initial keeper did not render");
  ...
  increment.click();
  await waitFor(function () { return document.getElementById("count").textContent === "1"; }, "pre-morph action did not update state");
  ...
  increment.click();
  await waitFor(function () { return document.getElementById("count").textContent === "2"; },
