...
const (
	...
	defaultRoot    = "jit/javascript/vanilla/examples"
...
func main() {
	...
	root := flag.String("root", defaultRoot, "directory containing the Vanilla examples")
	flag.Parse()
...
// newDemoHandler serves all Vanilla examples from root and mounts the profile
...
func resolveExamplesRoot(root string) (string, error) {
	...
	for {
		...
		standard := filepath.Join(dir, "engine", "jit", "javascript", "vanilla", "examples")
