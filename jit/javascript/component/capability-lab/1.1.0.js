...
// KitJS managed component: capability-lab@1.1.0
...
kit.component("capability-lab", {
  ...
  init: function (context) {
    ...
    if (subscribeDeepLinks) {
      stopDeepLinks = subscribeDeepLinks.call(kit.deepLinks, function (snapshot) {
        ...
        if (snapshot.path === NOTIFICATION_TAP_PATH) {
          scope.record("notification-tap", "pass", "granted", "received");
        }
  ...
  checkDeepLink: function () {
    ...
    return Promise.resolve().then(function () {
      ...
      scope.record("deep-links", "pass", "granted", "received");
      if (value.path === NOTIFICATION_TAP_PATH) {
        scope.record("notification-tap", "pass", "granted", "received");
      }
  ...
  showNotification: function () {
    ...
    return Promise.resolve().then(function () {
      ...
      if (tapRouteAttached) {
        scope.record("notification-tap", "running", "granted", "awaiting-tap");
        scope.statusText = "Đã gửi notification có route. Chạm notification để kiểm tra deep link.";
      } else {
