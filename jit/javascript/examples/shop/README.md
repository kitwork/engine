...
The HTML contract embeds the exact version in the managed component spec:

```html
<aside data-kit-component="shop-cart@1.0.0"></aside>
```

From `engine/jit/javascript`, reproduce the checked-in artifact with:
