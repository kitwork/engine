...
; (function (global, document) {
  ...
  function start() {
    ...
    if (!captureLiveThemePrepaint()) return false;
...
; (function (global, document) {
  ...
  var graph = { id: "ad221a1b71275300d6e1e2126f95777104072322747d4f3b4e03f6bfaedf135a", profile: "hydrate", services: services, components: components, actions: actions, grants: grants };
  if (core.reuse) {
