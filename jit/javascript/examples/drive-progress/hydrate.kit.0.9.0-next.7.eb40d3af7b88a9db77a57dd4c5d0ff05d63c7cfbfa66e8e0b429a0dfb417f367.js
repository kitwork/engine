...
; (function (document) {
  ...
  function installComponentGraph(source) {
    ...
    var graph = Object.freeze(graphSource);
  ...
  function sameStagedDelivery(incoming, responseURL) {
    ...
    for (var index = 0; index < delivery.assets.length; index++) {
      ...
      if (script.getAttribute("data-kitwork-jit") !== asset.role ||
        ...
        script.hasAttribute("nomodule") || type && type !== "text/javascript" &&
...
; (function (global, document) {
  ...
  var graph = { id: "cc30c38896f4beb50464a9a7ade3579e79ff55ae8730611b1f1f44448751af52", profile: "hydrate", services: services, components: components, actions: actions, grants: grants };
  if (core.reuse) {
