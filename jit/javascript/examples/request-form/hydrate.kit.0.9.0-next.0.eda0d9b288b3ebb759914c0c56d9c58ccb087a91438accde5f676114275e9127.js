...
;(function (document) {
  ...
  "component scope version as retain drive ignore text show bind class model if for key".split(" ").forEach(function (name) {
    RESERVED[name] = true;
  });
...
; (function (global, document) {
  ...
  var graph = { id: "d116881c6f96387c1805e12c706de23a42bb44dd5341dad9731a4d442089484f", profile: "hydrate", services: services, components: components };
  if (core.reuse) {
