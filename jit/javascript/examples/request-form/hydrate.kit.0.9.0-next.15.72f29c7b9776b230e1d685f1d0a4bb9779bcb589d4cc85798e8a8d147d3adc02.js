...
; (function (document) {
  ...
  function ownsElement(current, element) {
    ...
    return !!host && !current.disposed && core.scopes.get(host) === current &&
      connectedHere(host) && connectedHere(element) && nearest(element) === host;
  }
...
; (function (global, document) {
  ...
  var graph = { id: "eb63aa38a216d84613f3686b18e392722d7207169a5895cee5f378a00de9d842", profile: "hydrate", services: services, components: components, actions: actions, grants: grants };
  if (core.reuse) {
