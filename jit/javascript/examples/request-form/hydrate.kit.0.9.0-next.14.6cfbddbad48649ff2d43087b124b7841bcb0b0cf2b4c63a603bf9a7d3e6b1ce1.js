; (function (global, document) {
  ...
  var WeakOwner = typeof global.WeakRef === "function" ? global.WeakRef : null;
  ...
  function activeObservationRecord(observation) {
    ...
    var record = owner && observation.weak ? owner.deref() : owner;
  ...
  core.observe = function (value, owners) {
    ...
    owners.forEach(function (record) {
      ...
      seen.add(record);
      var observation = WeakOwner
        ? { owner: new WeakOwner(record), weak: true }
        : { owner: record, weak: false };
...
; (function (global, document) {
  ...
  var graph = { id: "e7836b802264a6fda3c97d029849702e96608bf88cfd3f97afe7f01502b37bcc", profile: "hydrate", services: services, components: components, actions: actions, grants: grants };
  if (core.reuse) {
