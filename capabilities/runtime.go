...
type Runtime interface {
	// Execute runs a lambda against its immutable Program in a pooled VM bound to this scope's
	...
	Execute(program *runtime.Program, fn *value.Lambda, args []value.Value) (gas uint64, err error)
}
