...
const homeRender = app.render("/view/pages/index.html").layout("/view/layout")
const dashboardRender = app.render("/view/pages/dashboard/index.html").layout({
...
const task = app.cron().fail(() => logger.error("Failed to fetch gold price"))
...
app.get("/send-mail").handle((context) => {
