...
The selected change set is **Windows-qualified as a candidate** from its first
full campaign. This document does not declare a final release. Promotion still
requires clean Windows and Linux reports for the same exact commit.
